...
function SingleSupervisorReport() {
  ...
  const getUserReport = async () => {
    try {
      ...
      const response = await fetch(
        `${API_BASE}/supervisor/report/${reportId}`,
        {
          headers: {
...
export default SingleSupervisorReport;
